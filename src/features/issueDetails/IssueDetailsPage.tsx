...
import saga from './commentSaga'
import reducer,{sliceName ,fetchComments} from './commentsSlice'
import { getIssueForComment,getCommentsData } from './commentsSelector';
...
export const IssueDetailsPage = ({
  ...
  const issue:Issue = useSelector(getIssueForComment(issueId))

  const { commentsLoading, commentsError, comments } = useSelector(
    getCommentsData(issueId),
    shallowEqual
  )
